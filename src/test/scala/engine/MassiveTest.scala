...
class MassiveTest {
  class MassiveTestImpl(m: Mass) extends Massive {
    override def mass: Mass = m
  ...
  val smaller = new MassiveTestImpl(new Mass(1000))
  val larger =  new MassiveTestImpl(new Mass(10000))
